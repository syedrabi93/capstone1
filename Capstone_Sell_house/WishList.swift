...
struct WishList {
    ...
    init(key: String = "" , propertyID : String , owner : String , price: Int ,contact: String, city: String , address: String ,pincode : String, availabitity:String, bedrooms:Int , bathrooms: Int , parking: Int , age: Int , size: Int , description : String , addedby : String, image : String){
        self.ref = nil
        self.key = key
